 ...
 * event, and Convex errors. It formats errors consistently and provides
 ...
 * Log a Convex error
 */
export function logConvexError(errorType: string, error: any, context?: any): void {
  logError('convex', errorType, error, context);
}
